...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50  bg-gradient-to-r from-gray-50 to-gray-100 backdrop-blur-sm ">
      ...
      <ul
        ref={sideMenuRef}
        className="flex md:hidden flex-col gap-8 py-20 px-10 fixed -right-50 top-0 bottom-0 w-50 z-50 h-screen bg-gradient-to-b from-pink-100 to-cyan-50 transition-all duration-500"
      >
